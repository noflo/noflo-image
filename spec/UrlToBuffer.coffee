...
unless noflo.isBrowser()
  ...
  UrlToBuffer = require '../components/UrlToBuffer-node.coffee'
else
  UrlToBuffer = require 'noflo-image/components/UrlToBuffer.js'

describe 'UrlToBuffer component', ->
  c = null
  ins = null
  out = null
  error = null
  beforeEach ->
    c = UrlToBuffer.getComponent()
